...
{
    public class ClaimStagingBase
    {
        #region Properties
        public int id { get; set; }
        public int? claim_info_id { get; set; }
        public int? file_id { get; set; }
        public int? seq_id { get; set; }
        public string action_type { get; set; }
        public string rre_info_id { get; set; }
        public string claim_control_num { get; set; }
        public DateTime? cms_doi { get; set; }
        public DateTime? industry_doi { get; set; }
        public DateTime? orm_term_date { get; set; }
        public string venue_state { get; set; }
        public string lost_time { get; set; }
        public double? total_medical_spent { get; set; }
        ...
        public DateTime? ip_dob { get; set; }
        public DateTime? ip_dod { get; set; }
        ...
        public double? no_fault_limit { get; set; }
        public DateTime? exhaust_date { get; set; }
        ...
        public int? claimant1_seq_no { get; set; }
        ...
        public int? claimant2_seq_no { get; set; }
        ...
        public int? claimant3_seq_no { get; set; }
        ...
        public int? claimant4_seq_no { get; set; }
        public DateTime? tpoc1_date { get; set; }
        public double? tpoc1_amount { get; set; }
        public DateTime? tpoc1_fund_delayed_date { get; set; }
        public int? tpoc1_seq_no { get; set; }
        public DateTime? tpoc2_date { get; set; }
        public double? tpoc2_amount { get; set; }
        public DateTime? tpoc2_fund_delayed_date { get; set; }
        public int? tpoc2_seq_no { get; set; }
        public DateTime? tpoc3_date { get; set; }
        public double? tpoc3_amount { get; set; }
        public DateTime? tpoc3_fund_delayed_date { get; set; }
        public int? tpoc3_seq_no { get; set; }
        public DateTime? tpoc4_date { get; set; }
        public double? tpoc4_amount { get; set; }
        public DateTime? tpoc4_fund_delayed_date { get; set; }
        public int? tpoc4_seq_no { get; set; }
        public DateTime? tpoc5_date { get; set; }
        public double? tpoc5_amount { get; set; }
        public DateTime? tpoc5_fund_delayed_date { get; set; }
        public int? tpoc5_seq_no { get; set; }
